                            ...
                            <div class="table-responsive">
                                <table id="tbl_user_group_rights" class="table" style="background-color: white;" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <th width="10%">Default Landing Page</th>
                                    ...
                                    <tbody>
                                        <?php foreach($rights as $right){ ?>
                                            <tr style="border: 1px solid lightgray;">
                                                ...
                                                <input  <?php echo ($right->is_default?'checked':'');?>

                                                 type="checkbox" name="is_default" value="<?php
                                                echo $right->link_code; ?>" onclick="fnChecked(this);" >   

                                                
                                                 

                                                
                                                 <input type="hidden" name="controller_name" value="<?php echo $right->controller_name; ?>">
                                                 </td>
                                                  <td>
